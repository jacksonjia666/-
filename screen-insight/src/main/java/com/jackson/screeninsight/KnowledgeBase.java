...
final class KnowledgeBase {
    static String advice(UsageAnalyzer.Report r){
        ...
        next=r.lateLeisure>60*60_000L?"下一步：先把深夜娱乐减少30分钟，观察一周后白天精神是否有变化。":r.lateProductive>60*60_000L?"下一步：最近深夜仍在工作或学习，别只看效率，也留意第二天精力；可以尝试提前30分钟收尾。":r.leisure>14*60*60_000L?"下一步：娱乐并不是浪费，但本周量偏高；先选一个最常用 App，减少每天20分钟。":change>15?"下一步：本周增量较大，先确认它来自临时工作还是无意识打开手机。":"下一步：保持当前节奏，并留意睡眠、精神和专注力是否同步改善。";
        return "做得好："+good+"\n需要留意："+watch+"\n"+next;
    }
}
